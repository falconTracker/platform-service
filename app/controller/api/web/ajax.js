...
class AjaxsController extends Controller {
  ...
  async getPageAjaxsAvg() {
    ...
    const result = await ctx.service.web.ajaxs.getPageAjaxsAvg(
      appId,
      url,
      beginTime,
      endTime,
  ...
  async getOneAjaxAvg() {
    ...
    const result = await ctx.service.web.ajaxs.getOneAjaxAvg(
      appId,
      url,
      beginTime,
      endTime,
  ...
  async getOneAjaxList() {
    ...
    const result = await ctx.service.web.ajaxs.getOneAjaxList(
      appId,
      url,
      pageNo,
      pageSize,

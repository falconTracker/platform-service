...
class ResourceController extends Controller {
  ...
  async getResourceForType() {
    ...
    const result = await ctx.service.web.resource.getResourceForType(
      appId,
      url,
      speedType,
      pageNo,
  ...
  async getOneResourceAvg() {
    ...
    const result = await ctx.service.web.resource.getOneResourceAvg(
      appId,
      url,
      beginTime,
      endTime
  ...
  async getOneResourceDetail() {
    ...
    const result = await ctx.service.web.resource.getOneResourceDetail(
      appId,
      id
    );
